...
export const LIVE_INDEXABLE_ROUTES: IndexableRoute[] = [
  ...
  {
    path: '/services/assessments/riasec-holland-code-career-test',
    changefreq: 'monthly',
    priority: '0.88',
  },
  {
  ...
  {
    path: '/services/assessments/emotional-intelligence-test-careers',
    changefreq: 'monthly',
    priority: '0.88',
  },
  {
  ...
  {
    path: '/services/assessments/entrepreneurial-aptitude-test',
    changefreq: 'monthly',
    priority: '0.88',
  },
