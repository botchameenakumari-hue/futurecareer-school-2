...
const assessments = [
  {
    route: '/services/assessments/riasec-holland-code-career-test/',
    fileName: 'future-career-school-riasec-holland-code-report.pdf',
    snapshotName: 'riasec-holland-code',
    answerSelector: '#scale-options button',
    chooseAudience: true,
  },
  {
    route: '/services/assessments/disc-personality-test-careers/',
    fileName: 'future-career-school-disc-workplace-style-report.pdf',
    snapshotName: 'disc-workplace-style',
    answerSelector: '#scale-options button',
    chooseAudience: true,
  },
  {
    route: '/services/assessments/emotional-intelligence-test-careers/',
    fileName: 'future-career-school-emotional-intelligence-report.pdf',
    snapshotName: 'emotional-intelligence',
    answerSelector: '#scale-options button',
    chooseAudience: true,
  },
  {
    route: '/services/assessments/vark-learning-style-test/',
    fileName: 'future-career-school-vark-learning-style-report.pdf',
    snapshotName: 'vark-learning-style',
    answerSelector: '#scale-options button',
    chooseAudience: true,
  },
  {
    route: '/services/assessments/enneagram-personality-test-careers/',
    fileName: 'future-career-school-enneagram-career-report.pdf',
    snapshotName: 'enneagram-career',
    answerSelector: '#scale-options button',
    chooseAudience: true,
  },
  {
    route: '/services/assessments/entrepreneurial-aptitude-test/',
    fileName: 'future-career-school-entrepreneurial-aptitude-report.pdf',
    snapshotName: 'entrepreneurial-aptitude',
    answerSelector: '#scale-options button',
    chooseAudience: true,
  },
];
